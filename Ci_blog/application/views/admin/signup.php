    ...
    <div class="container">
        <div class="row>">
            <div class="col-md-4 offset-md-4 pt-10" style="padding-top: 13%;">
                <form action="<?php echo base_url() . 'index.php/signup/index'; ?>" method="POST">
                    ...
                    <div>
                        <label for="exampleInputPassword1" class="form-label">Moble#</label>
                        <input type="tell" name="phone" value="<?php echo set_value('pass'); ?>" class="form-control"
                            id="exampleInputPassword1">
                    ...
                    <a href="<?php echo base_url() . 'index.php/login/index/'; ?>">Already signUp</a>
                </form>
            </div>
        </div>
    </div>
